...
u1 = User.create(username: 'Tanay', password: 'tanayjalan', email: 'tanay@stoopid.com', admin: true)
u2 = User.create(username: 'David', password: 'davidaaron', email: 'david@stoopid.com')
u3 = User.create(username: 'Jamie', password: 'pccjamie', email: 'jamie@stoopid.com')
u4 = User.create(username: 'Mike', password: 'mikeschechter', email: 'mike@stoopid.com')
u5 = User.create(username: 'Ryan', password: 'ryankuhel', email: 'ryan@stoopid.com')
